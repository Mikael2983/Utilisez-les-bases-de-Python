...
for category in url_categories:
    ...
    with open(csv_path, 'w', encoding='utf-8', newline='') as backup_file:
        ...
        for  url_book in url_books:
            ...
            image_nom = "data/"+ category +"/images/"+re.sub(r'[\\/*?:"<>|]', ' ', data_book["title"])+"-"+data_book["UPC"]+".jpg"
...
#
# #extraire tous les livres de chaque catégori e
#
# utils.scrape_category(categories_url)
...
#     page_number_li = soup.find("li", class_="current").string
#     page_number = page_number_li.split(" ")[-1]
...
#    for i in range (0,page_number):                             # boucle tant qu'il trouve une page suivante.
...
#             page_suivante = "page-"+str(i)+".html"  # recherche d'une page suivante
#         if page_suivante:
